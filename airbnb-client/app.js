...
AWS.config.accessKeyId = "YOUR_AWS_ACCESS_ID";
AWS.config.secretAccessKey = "YOUR_AWS_SECRET_KEY";
...
key: function (req, file, cb) {
 ...
 imageColl.push("https://s3.amazonaws.com/<Name of your S3 Bucket >/"+file.originalname+""+Date.now().toString()+"roomPhoto");
...
var uploadProfilePic = multer({
    storage: multerS3({
        ...
        key: function (req, file, cb) {
            ...
            console.log("length of file ",req.file);
            imageProfileColl=[];
            imageProfileColl.push("https://s3.amazonaws.com/<Name of your S3 Bucket >/"+file.originalname+""+Date.now().toString());
...
var uploadReview = multer({
    storage: multerS3({
        ...
        key: function (req, file, cb) {
            ...
            console.log("length of file ",req.file);
            listReviewImages=[];
            listReviewImages.push("https://s3.amazonaws.com/<Name of your S3 Bucket >/"+file.originalname+""+Date.now().toString());
            cb(null,file.originalname+""+Date.now().toString() );
        }
    })
});
...
var uploadProfileVideo = multer({
    storage: multerS3({
        ...
        key: function (req, file, cb) {
            ...
            uploadMyVideo="https://s3.amazonaws.com/<Name of your S3 Bucket >/"+file.originalname+""+Date.now().toString();
            cb(null,file.originalname+""+Date.now().toString() );
        }
    })
});
